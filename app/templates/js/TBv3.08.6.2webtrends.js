...
function WebTrends() {
    ...
    this.domain = "";
    this.timezone = -8;
    this.fpcdom = "." + document.domain.match(/([^.]+[.][^.]+$)|(^[^.]+$)/)[0];
    this.onsitedoms = "ups-houston.uat-l.thethinktank.com, houston.ups.dev:8888/, houston.ups.com, ups.com/houston";
    this.downloadtypes = "xls,doc,pdf,txt,csv,zip,mp4,mov,mp3,m4r";
...
function dcsMultiTrack() {
    if (typeof (_tag1) != "undefined") {
        _tag1.dcsMultiTrack();
    }
    if (typeof (_tag2) != "undefined") {
        _tag2.dcsMultiTrack();
    }
}
